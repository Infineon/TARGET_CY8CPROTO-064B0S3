...
#ifndef CYB06445LQI_S3D42
    #error "Unexpected target MCU; expected CYB06445LQI-S3D42. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
